 ...
 * @author jpk
 */
public class ShipBoundCostDao extends TimeStampEntityDao<ShipBoundCost> implements IShipBoundCostDao {
	 ...
	 */
	@Inject
	public ShipBoundCostDao(Provider<EntityManager> emPrvdr, IDbDialectHandler dbDialectHandler,
