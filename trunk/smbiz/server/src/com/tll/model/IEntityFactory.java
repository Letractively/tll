...
public interface IEntityFactory {
	 ...
	 * @param <E>
	 * @param entityClass
	 * @param generate Generate an id? This is necessary in order to later persist the entity.
	 *          Creating non-generated entities should only be used for prototyping and when it it
	 *          guaranteed the created entity will not be subject to persistence.
	 * @return The created entity
	 */
	<E extends IEntity> E createEntity(Class<E> entityClass, boolean generate);
