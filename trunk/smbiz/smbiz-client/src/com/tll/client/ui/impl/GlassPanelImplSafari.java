...
public class GlassPanelImplSafari extends GlassPanelImplStandard {
	...
	/*-{
	  var scrollWidth = @com.tll.client.ui.impl.GlassPanelImpl::getWindowScrollWidth()();
	  var scrollHeight = @com.tll.client.ui.impl.GlassPanelImpl::getWindowScrollHeight()();
