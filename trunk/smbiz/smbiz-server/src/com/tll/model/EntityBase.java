...
public abstract class EntityBase implements IEntity {
  ...
  private Integer version;
	...
	/**
	 * finds an entity of the given id in the set or null if not found.
  ...
  public boolean isGenerated() {
	...
	/**
	 * This method <b>must only</b> be called when a new entity is created and the id is generated.
	 * It will set the id and set the generated flag to true.
  ...
  public void setVersion(Integer version) {
    ...
    .append(IEntity.PK_FIELDNAME, getId())
