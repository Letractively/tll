...
/**
 * IMEntityServiceImpl - Server side support for the RPC {@link IMEntityService} implementation
 * delegate.
 * @author jpk
 * @param <E>
 */
public interface IMEntityServiceImpl<E extends IEntity> {
	 ...
	 * @param request The guaranteed non-<code>null</code> {@link EntityGetEmptyRequest}
	 * @param entityType The guaranteed non-<code>null</code> resolved {@link EntityType} for the
	 *          {@link EntityRequest}.
	 * @param payload
	 */
	 ...
	 * Loads an entity.
	 * @param requestContext Guaranteed non-<code>null</code>
	 * @param request The guaranteed non-<code>null</code> {@link EntityLoadRequest}
	 * @param entityType The guaranteed non-<code>null</code> resolved {@link EntityType} for the
	 *          {@link EntityRequest}.
	 ...
	 * Persists an entity.
	 * @param requestContext Guaranteed non-<code>null</code>
	 * @param request The guaranteed non-<code>null</code> {@link EntityPersistRequest}
	 * @param entityType The guaranteed non-<code>null</code> resolved {@link EntityType} for the
	 *          {@link EntityRequest}.
	 * @param payload The {@link EntityPayload} that is filled
	 */
	 ...
	 * Purges an entity.
	 * @param requestContext Guaranteed non-<code>null</code>
	 * @param request The guaranteed non-<code>null</code> {@link EntityPurgeRequest}
	 * @param entityType The guaranteed non-<code>null</code> resolved {@link EntityType} for the
	 *          {@link EntityRequest}.
	 * @param payload The {@link EntityPayload} that is filled
	 */
