...
public abstract class ListingFactory {
	 ...
	 */
	public static <S extends IListingSearch> RemoteListingWidget createRemoteListingWidget(IListingConfig<Model> config,
	 ...
	 */
	public static <S extends IListingSearch> RemoteListingOperator<S> createRemoteOperator(String listingName,
