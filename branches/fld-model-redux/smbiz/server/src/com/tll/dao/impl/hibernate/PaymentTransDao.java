 ...
 * @author jpk
 */
public class PaymentTransDao extends TimeStampEntityDao<PaymentTrans> implements IPaymentTransDao {
	 ...
	 */
	@Inject
	public PaymentTransDao(Provider<EntityManager> emPrvdr, IDbDialectHandler dbDialectHandler,
