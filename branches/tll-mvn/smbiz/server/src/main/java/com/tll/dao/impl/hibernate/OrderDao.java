 ...
 * @author jpk
 */
public class OrderDao extends TimeStampEntityDao<Order> implements IOrderDao {
	 ...
	 */
	@Inject
	public OrderDao(Provider<EntityManager> emPrvdr, IDbDialectHandler dbDialectHandler,
