 ...
 * @author jpk
 */
public class OrderTransDao extends TimeStampEntityDao<OrderTrans> implements IOrderTransDao {
	 ...
	 */
	@Inject
	public OrderTransDao(Provider<EntityManager> emPrvdr, IDbDialectHandler dbDialectHandler,
			IComparatorTranslator<Criterion> comparatorTranslator) {
		super(emPrvdr, dbDialectHandler, comparatorTranslator);
	}

	@Override
	public Class<OrderTrans> getEntityClass() {
