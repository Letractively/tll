...
public class ModelClearTest extends AbstractModelTest {
	...
	static void validateClear(final Model source, final List<Model> visited) throws Exception {
		assert source != null;
	...
	private AccountAddress getTestEntity() throws Exception {
	...
	public void test() throws Exception {
		final AccountAddress aa = getTestEntity();
