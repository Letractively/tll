...
public class Address extends EntityBase {
  ...
  @NotEmpty @Length(max=MAXLEN_ADDRESS1)
   ...
   */
  @Column(name="city")
  @NotEmpty @Length(max=MAXLEN_CITY)
   ...
   */
  @Column(name="country")
  @NotEmpty @Length(max=MAXLEN_COUNTRY)
  ...
  @NotEmpty @Email @Length(max=MAXLEN_EMAIL_ADDRESS)
  ...
  @NotEmpty @Length(max=MAXLEN_PROVINCE)
  ...
  @NotEmpty @Length(max=MAXLEN_POSTAL_CODE)
