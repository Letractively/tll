...
public class ListingCache {
	...
	public static <PropertyValueGroup> IListingHandler getHandler(HttpServletRequest request, String listingName) {
	 ...
	 */
	public static <PropertyValueGroup> String storeHandler(HttpServletRequest request, String listingName,
			IListingHandler handler) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <PropertyValueGroup> IListingHandler clearHandler(HttpServletRequest request, String listingName) {
